    ...
    public List getMenu(String name) {
        ...
        if (name.equals("main")) {
            for (int i = 0; i < list.size(); i++) {
                j++;
                result.add("<a class=\"opt"+ j +"\" href=\"/page/"+ list.get(i).getName() +"\">" + list.get(i).getTitle()+ "</a>");
            }
            return result;
        }
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ( !list.get(i).getName().equals(name)) {
                ...
                result.add("<a class=\"opt"+ j +" hover \" href=\"/page/"+ list.get(i).getName() +"\">" + list.get(i).getTitle()+ "</a>");
            }
